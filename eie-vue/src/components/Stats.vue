    ...
    <Container>
      ...
      >
        ...
        <div class="md:7/12 lg:w-1/2">
          ...
          >
            Mi empresa <span class="text-gray-500">{{ store.nombre }}</span> te
            puede ayudar con aquello que necesites
          </h2>
          ...
          <div class="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
            <div class="mt-8 flex gap-4 md:items-center">
              ...
              <div class="w-5/6">
                ...
                <p class="text-gray-500 dark:text-gray-400">
                  Te solucionamos las dificultades que tengas con tu empresa.
                </p>
              </div>
            </div>
            <div class="pt-4 flex gap-4 md:items-center">
              ...
              <div class="w-5/6">
                ...
                <p class="text-gray-500 dark:text-gray-400">
                  Estamos ubicados en el cifp Txurdinaga.
                </p>
              </div>
            </div>
          </div>
